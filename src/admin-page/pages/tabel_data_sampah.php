...
<php :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <body>
    ...
    <main class="h-full pb-16 overflow-y-auto">
      <div class="container grid px-6 mx-auto">
        ...
        <div class="flex flex-col w-full mx-auto space-y-7 lg:w-1/2">
          ...
          <form id="form-perorangan" action="tabel_result.php" method="GET" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <!-- Kelas -->
            ...
            <div class="flex justify-center">
              <button class="px-4 py-2 mt-3 text-sm font-medium leading-5 text-white transition-colors duration-150 transform bg-purple-600 border border-transparent rounded-lg hover:scale-105 hover:shadow-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                Submit
              </button>
            </div>
          </form>
          ...
          <!-- FORM SELURUH DATA -->
          <form id="form-seluruh-data" class="flex flex-col mb-10 space-y-7" action="tabel_result.php" method="GET">
            <!-- Radio: Seluruh Data -->
    ...
    $(document).ready(function() {
        ...
        // Load user berdasarkan kelas
        $('.kelas-radio').change(function() {
            var kelas = $(this).val();
            $('#nama-user-dropdown').prop('disabled', true).html('<option>Memuat...</option>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#nama-user-dropdown').html(options).prop('disabled', false);
                },
                error: function() {
                    $('#nama-user-dropdown').html('<option>Error memuat data</option>');
                }
            });
        });
    });
