...
// Ambil data dari jenis_sampah_multivalue
...
// Ambil data satuan dan jenis sampah
      ...
      <div class="flex flex-col flex-1 w-full">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            <div class="flex justify-start flex-1 lg:mr-3">
              <a href="./index.php" class="transition duration-300 hover:text-white">Kembali ke laman dashboard</a>
            </div>
          </div>
        </header>
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <div class="container grid px-6 mx-auto">
              <form method="POST" action="" class="w-full max-w-4xl px-4 py-3 mx-auto mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
